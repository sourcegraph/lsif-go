...
func TestDocstrings(t *testing.T) {
	...
	t.Run("TestFindDocstringFunc", func(t *testing.T) {
	...
	t.Run("TestFindDocstringInterface", func(t *testing.T) {
	...
	t.Run("TestFindDocstringStruct", func(t *testing.T) {
	...
	t.Run("TestFindDocstringField", func(t *testing.T) {
	...
	t.Run("TestFindDocstringConst", func(t *testing.T) {
	...
	t.Run("TestFindDocstringLocalVariable", func(t *testing.T) {
	...
	t.Run("TestFindDocstringInternalPackageName", func(t *testing.T) {
	...
	t.Run("TestFindDocstringExternalPackageName", func(t *testing.T) {
	...
	t.Run("TestFindExternalDocstring", func(t *testing.T) {
